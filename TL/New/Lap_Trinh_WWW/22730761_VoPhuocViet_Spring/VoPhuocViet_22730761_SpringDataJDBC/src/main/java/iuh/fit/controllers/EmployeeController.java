...
@RestController                        //tra data dang json
@RequestMapping("/api/employees")   //URL goc
@RequiredArgsConstructor
public class EmployeeController {
    private final EmployeeService employeeService;

    @PostMapping   //URL: POST /api/employees
    public Employee create(@RequestBody   // nhan du lieu json
                               Employee employee) {
    ...
    @GetMapping("/{id}")   //URL: GET /api/employees/{id}
